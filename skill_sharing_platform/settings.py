...
SOCIALACCOUNT_ACCOUNT_EMAIL_REQUIRED = True
SOCIALACCOUNT_ACCOUNT_UNIQUE_EMAIL = True
SOCIALACCOUNT_ACCOUNT_USERNAME_REQUIRED = False
SOCIALACCOUNT_ACCOUNT_EMAIL_VERIFICATION = "mandatory"
SOCIALACCOUNT_ACCOUNT_LOGIN_ON_PASSWORD_RESET = True
SOCIALACCOUNT_ACCOUNT_LOGIN_ON_GET = True
SOCIALACCOUNT_ACCOUNT_SESSION_REMEMBER = True
SOCIALACCOUNT_ACCOUNT_SIGNUP_PASSWORD_ENTER_TWICE = True
SOCIALACCOUNT_ACCOUNT_EMAIL_CONFIRMATION_EXPIRE_DAYS = 3
SOCIALACCOUNT_ACCOUNT_EMAIL_CONFIRMATION_HMAC = True
SOCIALACCOUNT_ACCOUNT_LOGIN_ON_EMAIL_CONFIRMATION = True
SOCIALACCOUNT_ACCOUNT_DEFAULT_HTTP_PROTOCOL = 'https'
SOCIALACCOUNT_ACCOUNT_ADAPTER = "accounts.adapters.CustomSocialAccountAdapter"
SOCIALACCOUNT_ACCOUNT_STORE_TOKENS = True
